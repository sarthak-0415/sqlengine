				        ...
				        if(first%2 != 0)
				        {
				        	while(temp_result1.find("&")!= string::npos)
					        {
					        	...
					        	temp_result1 = temp_result1.substr(temp_result1.find("&")+1, temp_result1.length());
				          		...
				          		if(query_type != 7)
				          			int_att = atoi(tokens[att_no-1].c_str());
				          		else
		        		...
		        		page_struct temp_page;
		          		...
		          		while(temp_page.page_data.find("&")!= string::npos)
		          		{
			          		...
			          		if(query_type != 7)
			          		{
			          			...
			          			{	vector<string> int_att_tokens = split(tokens[0],'#');
			          				//cout<<"int_att_tokens[1]"<<int_att_tokens[1];
			          				int_att = atoi(int_att_tokens[1].c_str());
			          			}	
			          		}	
			          		else
			          			str_att = tokens[att_no-1];
